...
\par{
Pour essayer QF-Test vous demandez une license d'évaluation~\footnote{\url{https://www.qfs.de/en/qf-test/free-trial.html}}.
}
\newpage

\section{Les premières étapes}
\par{
Chaque début peut être un défi. Ceci s'applique à l'écriture de ce tutoriel ainsi qu'à la formation dans
un outil.
}
